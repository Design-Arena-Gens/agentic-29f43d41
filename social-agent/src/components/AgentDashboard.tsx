      ...
      <header className="rounded-3xl border border-zinc-200 bg-gradient-to-br from-white via-white to-indigo-50 p-8 shadow-sm dark:border-zinc-800 dark:from-zinc-950 dark:via-zinc-950 dark:to-indigo-950/30">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-semibold text-zinc-900 dark:text-zinc-50">Social Media Operations Agent</h1>
          ...
          <div className="rounded-2xl border border-indigo-200 bg-white/80 px-4 py-3 text-sm shadow dark:border-indigo-900/50 dark:bg-indigo-950/40 dark:text-indigo-100">
            ...
            <div className="text-xs text-indigo-500/80 dark:text-indigo-200/70">Across {input.platforms.length || 3}+ platforms</div>
          </div>
        </div>
      </header>
          ...
          <div className="space-y-3">
            {strategy.weeklyCalendar.map((slot) => (
              ...
              >
                ...
                <p className="mt-2 text-xs font-semibold uppercase tracking-wide text-indigo-500 dark:text-indigo-300">Hook</p>
                <p className="text-sm text-zinc-600 dark:text-zinc-300">{slot.hook}</p>
                <p className="mt-2 text-xs font-semibold uppercase tracking-wide text-indigo-500 dark:text-indigo-300">CTA</p>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        ...
        <SectionCard title="Control Room">
          <div className="space-y-4">
            ...
            <div>
              <div className="text-xs font-semibold uppercase tracking-wide text-indigo-500 dark:text-indigo-300">Metrics to monitor</div>
              <ul className="mt-2 space-y-2">
                {strategy.metrics.map((metric) => (
                  <li
                    key={metric.name}
                    className="rounded-xl border border-zinc-200 bg-white/90 p-3 text-sm shadow-sm dark:border-zinc-700 dark:bg-zinc-900/50"
                  >
